# Ethical Tech CoLab library alignment

## Purpose

The public [Ethical Tech CoLab library shelf](https://yorkerhodes3.github.io/pageturn-book/shelf/)
currently presents 21 production publications in three collections. This map
...
Titles and descriptions can change; confirm the production shelf before
publishing a final syllabus.

## At a glance

The existing library is strongest in:

- humanitarian decision support under uncertainty;
- civilian evacuation and protection;
- transparent, contestable scoring;
- provenance and evidence trails;
- simulations framed as teaching tools rather than forecasts;
- explicit limits and refusals;
- environmental and structural-risk analysis.

The three proposed sourcebooks add comparatively thinner areas:

- moral and institutional foundations across the whole curriculum;
- democratic participation and Plurality mechanisms;
- forecast literacy and frontier-governance scenarios.

## Foundational and policy collection

### 1. *What Is Ethical AI?* - 46 pages

**Best weeks:** 1-4, 6, 13-14
**DAPPR:** all five lenses
...
**Best weeks:** 5 and 13
**DAPPR:** dignity, power, reversibility
**Use:** widen lifecycle analysis beyond training metrics to energy, water,
...
**Best weeks:** 4 and 5
**DAPPR:** power, reversibility
**Use:** show model selection as constrained optimization across verified task
quality, reliability, latency, energy, token economics, privacy,
...
**Best weeks:** 6 and 11
**DAPPR:** dignity, agency, reversibility
**Use:** demonstrate that information quality can change a predicted decision
...
**Best weeks:** 4 and 6
**DAPPR:** dignity, agency, power
**Use:** teach why legal obligation and operational feasibility must remain
...
**Best weeks:** 4 and 11
**DAPPR:** agency, power, reversibility
**Use:** examine the difference between an agent's recorded explanation and
...
**Best weeks:** 4, 11, and 12
**DAPPR:** agency, power, reversibility
**Use:** a vivid alignment and specification case. The system need not be
...
### 8. *After the Corridor* - 22 pages

**Best weeks:** 6, 13, and 14
**DAPPR:** dignity, agency, power, reversibility
**Use:** connect evacuation tools to long-term refugee inclusion, legal
status, information, and digital public goods. Its explicit refusal to build
...
**Best weeks:** 6 and 9
**DAPPR:** dignity, power, reversibility
**Use:** expose the moral and operational assumptions inside human and
...
**Best week:** 6
**DAPPR:** dignity, agency, reversibility
**Use:** resist the assumption that evacuation is automatically the good
...
**Best weeks:** 6 and 7
**DAPPR:** agency, plurality, power
**Use:** study how belief, family, neighbors, identity, and repeated
...
**Best weeks:** 4, 5, and 6
**DAPPR:** dignity, power, reversibility
**Use:** trace adjustable and hardcoded choices in rapid damage assessment.
...
**Best week:** 6
**DAPPR:** dignity, power
**Use:** show how measurement can resist a misleading proxy. A quiet day in a
...
**Best weeks:** 5, 6, and 13
**DAPPR:** dignity, agency, power
**Use:** distinguish prevalence from structural risk and study the evidence
...
### 15. *The Agentic Behavior Observatory* - 12 pages

**Best weeks:** 4 and 11
**DAPPR:** dignity, plurality, power
**Use:** treat source code as a claim about who a modeled population contains.
...
**Best weeks:** 2, 10, and 11
**DAPPR:** agency, power
**Use:** compare AI-supported question generation with independent and
...
**Best weeks:** 1 and 12
**DAPPR:** agency, power
**Use:** create shared vocabulary before a mixed technical/policy discussion.
...
**Best weeks:** 11-13
**DAPPR:** plurality, power, reversibility
**Use:** rehearse multi-party negotiation while preserving the crucial label:
...
**Best weeks:** 4 and 5
**DAPPR:** agency, power
**Use:** assemble ownership claims, evidence, and gaps without converting
...
**Best weeks:** 4 and 5
**DAPPR:** dignity, agency, reversibility
**Use:** teach purposeful restraint. The application records attendance and
refuses to infer ownership, value, or authenticity. Ask students to define the
...
### Cluster A - Foundations to institutional practice

1. *What Is Ethical AI?*
2. *AI Model Performance*
3. *The Agentic Behavior Observatory*
4. *The Digital Provenance Passport*
5. *VANGO*

**Learning arc:** purpose -> model choice -> hidden assumptions -> evidence ->
restraint.

### Cluster B - Humanitarian uncertainty

1. CERAI
2. Evacuation Inform Index
3. ERCF
4. Evacuation Simulator
5. ERUS
6. HASTE
7. Mariupol Severity Model
8. *After the Corridor*

**Learning arc:** obligation -> competing risk -> cost -> social behavior ->
uncertainty -> remote evidence -> deprivation -> durable solutions.

### Cluster C - Power, negotiation, and future systems

1. *The Only Winning Move*
2. *The Diplomatic Simulator*
3. *Agentic Language Development*
4. *AI's Carbon Footprint*
5. *The Forced Labor Structural Risk Index*

**Learning arc:** alignment -> negotiation -> auditability -> material
infrastructure -> structural exploitation.

## Where the proposed sourcebooks fit

| Proposed portable book | Existing library role | Gap it fills |
| --- | --- | --- |
| [*Power and the Human Person*](../books/book-01-power-and-the-human-person.md) | Companion and teaching edition for *What Is Ethical AI?* and applied cases | One continuous moral-to-institutional semester narrative |
| [*Plural Technology and Democratic Agency*](../books/book-02-plural-technology-and-democratic-agency.md) | Democratic-design companion to public tools and simulations | Participation, deliberation, agenda power, identity, digital public infrastructure |
| [*Governing AI Futures*](../books/book-03-governing-ai-futures.md) | Scenario and policy companion to War Games and Diplomatic Simulator | Forecast literacy, frontier governance, verification, legitimacy and handoff |

## Suggested case-method pattern

For each CoLab publication:

1. State the humanitarian or public problem.
2. Identify the explicit ethical safeguard.
3. Name the public value sought.
4. Locate every source of human judgment.
5. Identify a hardcoded or institutional choice.
6. Find the system's explicit limit or refusal.
7. Ask who could contest an output and how.
8. Propose one monitoring signal and stop condition.

This extends the CoLab chapter's three lenses - problem, safeguards, and
measurable public value - with DAPPR's power and reversibility questions.
